...
public class US_018StepDefinitions {
    ...
    public void seeAllCustomerInfoOnThatPage() {
        for (WebElement eachcustomerInformationPage : us_18manageCustomerPage.viewCustomerInfoPageElements) {
            System.out.println("tc2" + "=" + eachcustomerInformationPage.getText());

            Assert.assertTrue(us_18manageCustomerPage.viewCustomerInfoPageElements.size() > 0);
    ...
    public void seeAllCustomerInfoPopulated() {
        ...
        for (WebElement eachcustomerInformationpopulate : us_18manageCustomerPage.editCustomerInfoPagePopulate) {
            System.out.println("tc3" + "=" + eachcustomerInformationpopulate.getText());

            Assert.assertTrue(us_18manageCustomerPage.editCustomerInfoPagePopulate.size() > 0);
