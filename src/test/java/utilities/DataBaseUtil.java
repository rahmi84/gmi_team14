...
public class DataBaseUtil {
    ...
    private static final String dbusername = ConfigReader.getProperty("db_user");
    private static final String dbpassword = ConfigReader.getProperty("db_password");
    private static final String connectionUrl =ConfigReader.getProperty("database_url");
